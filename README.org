...
#+begin_note
On Linux, getting proper pixel-level wheel mouse input can be finicky, depending on graphics toolkit and input manager in use.  See [[https://github.com/jdtsmith/ultra-scroll/discussions/52#discussioncomment-18111123][this comment]] for tips.
#+end_note
