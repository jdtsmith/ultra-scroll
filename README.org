...
#+html: <a href="https://stable.melpa.org/#/ultra-scroll"><img alt="MELPA Stable" src="https://stable.melpa.org/packages/ultra-scroll-badge.svg"/></a>
...
When point leaves the initial window bounds during scrolling, ~ultra-scroll~ can perform various helpful functions, restoring the state after scrolling ends.  The custom variable ~ultra-scroll-restore-time~ can be used to configure the delay time for restoring state.
