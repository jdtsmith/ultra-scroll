...
* v0.7.1 (2026-08-10)
- Remove spurious scroll-margin warning.

* v0.7.0 (2026-08-02)
- Non-zero scroll-margin is now supported (set to zero and restore
  after scrolling completes).
- Handle killed buffer or window correctly for restoring cursor type,
  etc.
